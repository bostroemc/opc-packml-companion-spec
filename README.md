...
Note that due to strict formating requirements imposed by the OPC Foundation, the final document will likely be created by manually merging the autogenerated document here into the previous version of OPC 30050 (v 1.01).   
